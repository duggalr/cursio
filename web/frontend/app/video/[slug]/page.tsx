      ...
      >
        ...
        {video.source_url && (
          <a
            ...
            className="mt-1 inline-flex items-center gap-1 text-xs text-[var(--color-muted)] underline decoration-[var(--color-border)] underline-offset-2 hover:decoration-[var(--color-foreground)]"
          >

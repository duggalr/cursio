    ...
    <Link href={`/video/${video.slug || video.id}`}>
      ...
      >
        <div className="relative aspect-video w-full overflow-hidden">
          ...
          {/* Featured badge */}
          {video.is_featured && (
            <div className="absolute top-2 left-2 z-10 flex items-center gap-1 rounded-md bg-black/70 px-2 py-0.5 text-[10px] font-medium text-yellow-400 backdrop-blur-sm">
